...
// Privacy API strings.
$string['privacy:metadata:local_ltifed_providers'] = 'Stores admin-configured provider connection settings. This data is not personal user data — it is set by the site administrator to connect to remote Moodle provider sites.';
$string['privacy:metadata:local_ltifed_providers:label'] = 'A human-readable label for the provider connection.';
$string['privacy:metadata:local_ltifed_providers:providerurl'] = 'The base URL of the remote Moodle provider site.';
$string['privacy:metadata:local_ltifed_providers:wstoken'] = 'The encrypted web service token used to authenticate with the remote provider.';
$string['privacy:metadata:local_ltifed_providers:autosync'] = 'Whether automatic catalog synchronisation is enabled for this provider.';
$string['privacy:metadata:local_ltifed_providers:lastsync'] = 'Timestamp of the last successful catalog sync.';
$string['privacy:metadata:local_ltifed_providers:syncstatus'] = 'The status of the last sync operation (ok or error).';
$string['privacy:metadata:local_ltifed_providers:syncmessage'] = 'Any error message from the last sync operation.';
$string['privacy:metadata:local_ltifed_catalog_cache'] = 'Stores a cache of LTI tool metadata fetched from remote provider sites. This is tool/course metadata from the provider, not personal user data.';
$string['privacy:metadata:local_ltifed_catalog_cache:providerid'] = 'Reference to the provider this tool belongs to.';
$string['privacy:metadata:local_ltifed_catalog_cache:remoteuuid'] = 'The unique identifier of the tool on the remote provider site.';
$string['privacy:metadata:local_ltifed_catalog_cache:name'] = 'The name of the LTI tool as published by the provider.';
$string['privacy:metadata:local_ltifed_catalog_cache:description'] = 'A description of the LTI tool as published by the provider.';
$string['privacy:metadata:local_ltifed_catalog_cache:coursefullname'] = 'The full name of the course containing the tool on the provider site.';
$string['privacy:metadata:local_ltifed_catalog_cache:ltiversion'] = 'The LTI version of this tool.';
$string['privacy:metadata:local_ltifed_catalog_cache:registration_url'] = 'The dynamic registration URL for this tool on the provider.';
$string['privacy:metadata:local_ltifed_catalog_cache:registration_token'] = 'The registration token associated with this tool\'s dynamic registration URL.';
$string['privacy:metadata:local_ltifed_catalog_cache:regstate'] = 'The current registration state of this tool on this site.';
$string['privacy:metadata:local_ltifed_catalog_cache:regerror'] = 'Any error message from a failed registration attempt.';
